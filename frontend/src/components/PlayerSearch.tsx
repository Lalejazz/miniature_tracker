    ...
    <div className="player-search">
      ...
      <form onSubmit={handleSearch} className="search-form">
        <div className="search-filters">
          ...
          <div className="form-group">
            <label>Filter by Game Types (optional)</label>
            <div className="game-types-filter">
              {(Object.keys(GAME_TYPE_LABELS) as GameType[]).map(gameType => (
                <label key={gameType} className="game-type-checkbox">
                  <input
                    type="checkbox"
                    checked={searchRequest.game_types?.includes(gameType) || false}
            ...
            {searchResults.map(player => (
              <div key={player.user_id} className="player-card">
                ...
                <div className="player-details">
                  ...
                  <div className="player-game-types">
                    <strong>Interested in:</strong>
                    <div className="game-types-list">
                      {player.game_types.map(gameType => (
                        <span key={gameType} className="game-type-tag">
